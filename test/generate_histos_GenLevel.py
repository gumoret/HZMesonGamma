...
if isZAnalysis: histo_map[list_histos[0]]  = ROOT.TH1F(list_histos[0],"M_{Z}", 300, 50., 200.) 
elif isHAnalysis: histo_map[list_histos[0]]  = ROOT.TH1F(list_histos[0],"M_{H}", 300, 124.8, 125.2) 
...
histo_map[list_histos[2]]  = ROOT.TH1F(list_histos[2],"p_{T} of the 1st track", 250, 0.,250.)
histo_map[list_histos[3]]  = ROOT.TH1F(list_histos[3],"p_{T} of the 2nd track", 300, 0., 300.)
...
histo_map[list_histos[11]] = ROOT.TH1F(list_histos[11],"p_{T} of the #gamma", 400, 0., 500.)
...
histo_map[list_histos[14]] = ROOT.TH1F(list_histos[14],"p_{T} of boson", 700, 0., 700.)
