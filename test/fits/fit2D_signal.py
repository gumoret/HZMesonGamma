...
ROOT.gROOT.ProcessLineSync(".L ./fits/dCB/RooDoubleCBFast.cc+")
...
# Save plots
output_path_pdf = "~/cernbox/www/HZMesonGamma/fit2D/fit_projections_2D.pdf"
output_path_png = "~/cernbox/www/HZMesonGamma/fit2D/fit_projections_2D.png"
